...
class ComponentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create component" do
    assert_difference('Component.count') do
      post components_url, params: { component: { description: @component.description, resistance_impact: @component.resistance_impact } }
    end
  ...
  test "should update component" do
    patch component_url(@component), params: { component: { description: @component.description, resistance_impact: @component.resistance_impact } }
