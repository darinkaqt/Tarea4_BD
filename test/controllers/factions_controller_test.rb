...
class FactionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create faction" do
    assert_difference('Faction.count') do
      post factions_url, params: { faction: { name_faction: @faction.name_faction, rebel?: @faction.rebel? } }
    end
  ...
  test "should update faction" do
    patch faction_url(@faction), params: { faction: { name_faction: @faction.name_faction, rebel?: @faction.rebel? } }
