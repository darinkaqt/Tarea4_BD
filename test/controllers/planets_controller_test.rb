...
class PlanetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create planet" do
    assert_difference('Planet.count') do
      post planets_url, params: { planet: { faction_id: @planet.faction_id, name_local: @planet.name_local } }
    end
  ...
  test "should update planet" do
    patch planet_url(@planet), params: { planet: { faction_id: @planet.faction_id, name_local: @planet.name_local } }
